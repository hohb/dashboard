<?php include('pageheader.php'); ?>
	...
	<div id="status-bar"><div class="container_12">
		<ul id="status-infos">
			<li class="spaced">Logged as: <strong><?php $user->getUser($_SESSION['userid'],'firstname') ?></strong></li>
			<li>
				<a href="#" class="button" title="5 messages"><img src="assets/images/icons/fugue/mail.png" width="16" height="16"> <strong>5</strong></a>
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		<div class="float-left">
			<button type="button"><img src="assets/images/icons/fugue/navigation-180.png" width="16" height="16"> Back to list</button>
		...
		<div class="float-right">
			...
			<button type="button"><img src="assets/images/icons/fugue/tick-circle.png" width="16" height="16"> Save</button>
		</div>
	</div></div>
	<!-- End control bar -->
	...
	<article class="container_12">
		<section class="grid_4">
			<!--<div class="block-border"><div class="block-content">-->
				...
				<ul class="favorites no-margin with-tip" title="Context menu available!">
					<li>
						<img src="assets/images/icons/web-app/48/Info.png" width="48" height="48">
						<a href="#">Settings<br>
						<small>System &gt; Settings</small></a>
						<ul class="mini-menu">
							<li><a href="#" title="Move down"><img src="assets/images/icons/fugue/arrow-270.png" width="16" height="16"></a></li>
							<li><a href="#" title="Delete"><img src="assets/images/icons/fugue/cross-circle.png" width="16" height="16"> Delete</a></li>
						</ul>
					</li>
					<li>
						<img src="assets/images/icons/web-app/48/Line-Chart.png" width="48" height="48">
						<a href="#">Bandwidth usage<br>
						<small>Stats &gt; Server &gt; Bandwidth usage</small></a>
						<ul class="mini-menu">
							<li><a href="#" title="Move up"><img src="assets/images/icons/fugue/arrow-090.png" width="16" height="16"></a></li>
							<li><a href="#" title="Move down"><img src="assets/images/icons/fugue/arrow-270.png" width="16" height="16"></a></li>
							<li><a href="#" title="Delete"><img src="assets/images/icons/fugue/cross-circle.png" width="16" height="16"> Delete</a></li>
						</ul>
					</li>
					<li>
						<img src="assets/images/icons/web-app/48/Modify.png" width="48" height="48">
						<a href="#">New post<br>
					...
					<li>
						<img src="assets/images/icons/web-app/48/Pie-Chart.png" width="48" height="48">
					...
					<li>
						<img src="assets/images/icons/web-app/48/Comment.png" width="48" height="48">
			...
			<div class="block-border"><div class="block-content">
				...
				<div class="block-controls">
					<ul class="controls-tabs js-tabs same-height with-children-tip">
						<li><a href="#tab-stats" title="Charts"><img src="assets/images/icons/web-app/24/Bar-Chart.png" width="24" height="24"></a></li>
						<li><a href="#tab-comments" title="Comments"><img src="assets/images/icons/web-app/24/Comment.png" width="24" height="24"></a></li>
						<li><a href="#tab-medias" title="Medias"><img src="assets/images/icons/web-app/24/Picture.png" width="24" height="24"></a></li>
						<li><a href="#tab-users" title="Users"><img src="assets/images/icons/web-app/24/Profile.png" width="24" height="24"></a></li>
						<li><a href="#tab-infos" title="Informations"><img src="assets/images/icons/web-app/24/Info.png" width="24" height="24"></a></li>
					</ul>
				</div>
				<form class="form" id="tab-stats" method="post" action="">
					<fieldset class="grey-bg">
						...
						<div class="float-left gutter-right">
							...
							<span class="input-type-text"><input type="text" name="stats-period" id="stats-period" value=""><img src="assets/images/icons/fugue/calendar-month.png" width="16" height="16"></span>
						</div>
						<div class="float-left gutter-right">
		...
		<section class="grid_6">
			<div class="block-border"><div class="block-content">
				<h1>
					Planning
					<a href="#" onClick="openModal(); return false;"><img src="assets/images/icons/fugue/cards-address.png" width="16" height="16"> Open modal</a>
				</h1>
				<div class="block-controls">
					<ul class="controls-buttons">
						<li><a href="#" title="Yesterday"><img src="assets/images/icons/fugue/navigation-180.png" width="16" height="16"></a></li>
						<li class="sep"></li>
						<li class="controls-block"><strong>Monday 10</strong></li>
						<li class="sep"></li>
						<li><a href="#" title="Tomorrow"><img src="assets/images/icons/fugue/navigation.png" width="16" height="16"></a></li>
					</ul>
				</div>
				<ul class="planning no-margin">
					...
					<li>
						<a href="#"><img src="assets/images/icons/fugue/user-red.png" width="16" height="16"> John</a>
						<ul>
					...
					<li>
						<a href="#"><img src="assets/images/icons/fugue/user-green.png" width="16" height="16"> Sam</a>
						<ul>
							<li class="lunch from-12 to-14"></li>
							<li class="current-time at-9-30"></li>
					...
					<li>
						<a href="#"><img src="assets/images/icons/fugue/user-gray-female.png" width="16" height="16"> Lena</a>
						<ul>
							<li class="lunch from-12 to-14"></li>
							<li class="current-time at-9-30"></li>
					...
					<li>
						<a href="#"><img src="assets/images/icons/fugue/user-gray.png" width="16" height="16"> Marc</a>
						<ul>
							<li class="lunch from-12 to-14"></li>
							<li class="current-time at-9-30"></li>
					...
					<li>
						<span><img src="assets/images/icons/fugue/user-female.png" width="16" height="16"> Jane</span>
						<ul class="zebras"></ul>
					</li>
					<li>
						<a href="#"><img src="assets/images/icons/fugue/user-business-gray.png" width="16" height="16"> Erik</a>
						<ul>
							<li class="lunch from-12 to-14"></li>
							<li class="current-time at-9-30"></li>
					...
					<li>
						<a href="#"><img src="assets/images/icons/fugue/user-business-boss.png" width="16" height="16"> George</a>
						<ul>
							<li class="lunch from-12 to-14"></li>
							<li class="current-time at-9-30"></li>
					...
					<li>
						<a href="#"><img src="assets/images/icons/fugue/user-business.png" width="16" height="16"> James</a>
						<ul>
							<li class="lunch from-12 to-14"></li>
							<li class="current-time at-9-30"></li>
					...
					<li>
						<a href="#"><img src="assets/images/icons/fugue/user-black.png" width="16" height="16"> Nathan</a>
						<ul>
							<li class="lunch from-12 to-14"></li>
							<li class="current-time at-9-30"></li>
					...
					<li>
						<a href="#"><img src="assets/images/icons/fugue/user-thief.png" width="16" height="16"> Elwin</a>
						<ul>
							<li class="lunch from-12 to-14"></li>
							<li class="current-time at-9-30"></li>
							<li class="event-blue from-8 to-12"><a href="#" title="Event description" class="with-tip">8:00 - 12:00</a></li>
		...
		<section class="grid_6">
			<div class="block-border"><div class="block-content">
				...
				<ul class="shortcuts-list">
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Bar-Chart.png" width="48" height="48"> Stats
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Comment.png" width="48" height="48"> Comments
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Email.png" width="48" height="48"> Mail
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Delete.png" width="48" height="48"> Exit
					</a></li>
				</ul>
				<h3>Content management</h3>
				<ul class="shortcuts-list">
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Modify.png" width="48" height="48"> Write
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Profile.png" width="48" height="48"> My profile
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Search.png" width="48" height="48"> Search
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Add.png" width="48" height="48"> Add post
					</a></li>
				</ul>
				<h3>System</h3>
				<ul class="shortcuts-list">
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Info.png" width="48" height="48"> Settings
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Loading.png" width="48" height="48"> Monitoring
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Picture.png" width="48" height="48"> Images
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Pie-Chart.png" width="48" height="48"> Usage
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Print.png" width="48" height="48"> Print report
					</a></li>
					<li><a href="#">
						<img src="assets/images/icons/web-app/48/Save.png" width="48" height="48"> Backup
					</a></li>
				</ul>
			</div></div>
		</section>
		...
		<section class="grid_12">
			<div class="block-border"><div class="block-content">
				...
				<div class="block-controls">
					<ul class="controls-buttons">
						<li><a href="#" title="Previous Month"><img src="assets/images/icons/fugue/navigation-180.png" width="16" height="16"></a></li>
						<li class="sep"></li>
						<li class="controls-block"><strong>March</strong></li>
						<li class="sep"></li>
						<li><a href="#" title="Next Month"><img src="assets/images/icons/fugue/navigation.png" width="16" height="16"></a></li>
					</ul>
				</div>
				<ul class="planning no-margin">
					<li class="planning-header">
			...
			<div class="block-border"><form class="block-content form" id="simple_form" method="post" action="">
				...
				<fieldset>
					...
					<p>
						...
						<span class="input-type-text margin-right error relative"><input type="text" name="simple-calendar" id="simple-calendar" value="" class="datepicker"><img src="assets/images/icons/fugue/calendar-month.png" width="16" height="16"><span class="check-error"></span></span>
			...
			<div class="block-border"><form class="block-content form" id="complex_form" method="post" action="">
				...
				<div class="block-controls">
					<ul class="controls-tabs js-tabs">
						<li class="current"><a href="#" title="Charts"><img src="assets/images/icons/web-app/24/Bar-Chart.png" width="24" height="24"></a></li>
						<li><a href="#" title="Comments"><img src="assets/images/icons/web-app/24/Comment.png" width="24" height="24"></a></li>
						<li><a href="#" title="Medias"><img src="assets/images/icons/web-app/24/Picture.png" width="24" height="24"></a></li>
						<li><a href="#" title="Users"><img src="assets/images/icons/web-app/24/Profile.png" width="24" height="24"></a></li>
						<li><a href="#" title="Informations"><img src="assets/images/icons/web-app/24/Info.png" width="24" height="24"></a></li>
					</ul>
				</div>
				...
				<div class="columns">
					<div class="col200pxL-left">
						...
						<ul class="side-tabs js-tabs same-height">
							...
							<li class="icon-tab with-margin"><a href="javascript:void(0)" title="Add tab"><img src="assets/images/icons/add.png" width="16" height="16"></a></li>
						</ul>
					</div>
					<div class="col200pxL-right">
						<div id="tab-global" class="tabs-content">
							<ul class="tabs js-tabs same-height">
								...
								<li class="with-margin"><a href="javascript:void(0)" title="Add tab"><img src="assets/images/icons/add.png" width="16" height="16"></a></li>
							</ul>
							<div class="tabs-content">
								<div id="tab-locales">
									...
									<ul class="mini-tabs no-margin js-tabs same-height">
										<li><a href="#tab-en"><img src="assets/images/icons/flags/us.png" width="16" height="11" alt="English" title="English"></a></li>
										<li class="current"><a href="#tab-fr"><img src="assets/images/icons/flags/fr.png" width="16" height="11" alt="French" title="French"></a></li>
										<li><a href="#tab-de"><img src="assets/images/icons/flags/de.png" width="16" height="11" alt="German" title="German"></a></li>
										<li><a href="#tab-es"><img src="assets/images/icons/flags/es.png" width="16" height="11" alt="Spanish" title="Spanish"></a></li>
										<li><a href="#tab-ru"><img src="assets/images/icons/flags/ru.png" width="16" height="11" alt="Russian" title="Russian"></a></li>
										<li><a href="#tab-jp"><img src="assets/images/icons/flags/jp.png" width="16" height="11" alt="Japanese" title="Japanese"></a></li>
									</ul>
									<div id="tab-en">
										<fieldset class="grey-bg">
			...
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				...
				<div class="block-controls">
					...
					<ul class="controls-buttons">
						...
						<li><a href="#" title="Previous"><img src="assets/images/icons/fugue/navigation-180.png" width="16" height="16"> Prev</a></li>
						...
						<li><a href="#" title="Next">Next <img src="assets/images/icons/fugue/navigation.png" width="16" height="16"></a></li>

						<li class="sep"></li>

						<li><a href="#"><img src="assets/images/icons/fugue/arrow-circle.png" width="16" height="16"></a></li>
				...
				<div class="no-margin"><table class="table" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="#"><small><img src="assets/images/icons/fugue/image.png" width="16" height="16" class="picto"> jpg | 12 Ko</small></a></td>
							...
							<td class="table-actions">
								...
								<a href="#" title="Edit" class="with-tip"><img src="assets/images/icons/fugue/pencil.png" width="16" height="16"></a>

								<a href="#" title="Delete" class="with-tip"><img src="assets/images/icons/fugue/cross-circle.png" width="16" height="16"></a>
						...
						<tr>
							...
							<td><a href="#"><small><img src="assets/images/icons/fugue/image.png" width="16" height="16" class="picto"> jpg | 14 Ko</small></a></td>
						...
						<tr>
							...
							<td><a href="#"><small><img src="assets/images/icons/fugue/image.png" width="16" height="16" class="picto"> jpg | 9 Ko</small></a></td>
						...
						<tr>
							...
							<td><a href="#"><small><img src="assets/images/icons/fugue/image.png" width="16" height="16" class="picto"> jpg | 21 Ko</small></a></td>
						...
						<tr>
							...
							<td><a href="#"><small><img src="assets/images/icons/fugue/image.png" width="16" height="16" class="picto"> jpg | 20 Ko</small></a></td>
				...
				<div class="block-footer">
					...
					<img src="assets/images/icons/fugue/arrow-curve-000-left.png" width="16" height="16" class="picto">
		...
		<section class="grid_12">
			...
			<div class="block-border"><form class="block-content form" name="table_form" id="table_form" method="post" action="">
				...
				<h1>
					...
					<a href="#"><img src="assets/images/icons/fugue/plus-circle-blue.png" width="16" height="16"> add</a>
					...
					<ul class="grid dark-grey-gradient">
						...
						<li>
							...
							<ul class="grid-actions">
								...
								<li><a href="#" title="Edit" class="with-tip"><img src="assets/images/icons/fugue/pencil.png" width="16" height="16"></a></li>

								<li><a href="#" title="Delete" class="with-tip"><img src="assets/images/icons/fugue/cross-circle.png" width="16" height="16"></a></li>
						...
						<div class="with-head">
							...
							<div class="dark-grey-gradient with-padding" style="height:300px; overflow: auto">
								...
								<div class="loading-tab stick-to-top">
									...
									<span class="button">File1.zip <img src="assets/images/icons/fugue/tick-circle-blue.png" width="16" height="16"></span>&nbsp;

									<span class="button">File2.zip <img src="assets/images/icons/fugue/cross-circle.png" width="16" height="16"></span>&nbsp;
								...
								<ul class="files">
									...
									<li><a href="#">
										...
										<span><img src="assets/images/demo/files/file1-mini.png" width="64" height="45" class="thumb"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/demo/files/file2-mini.png" width="64" height="45" class="thumb"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/demo/files/file3-mini.png" width="64" height="45" class="thumb"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/demo/files/file4-mini.png" width="64" height="45" class="thumb"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/icons/finefiles/64/excel.png" width="64" height="64"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/demo/files/file5-mini.png" width="64" height="45" class="thumb"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/demo/files/file6-mini.png" width="64" height="45" class="thumb"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/icons/finefiles/64/text.png" width="64" height="64"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/icons/finefiles/64/swf.png" width="64" height="64"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/demo/files/file7-mini.png" width="64" height="45" class="thumb"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/demo/files/file8-mini.png" width="64" height="45" class="thumb"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/demo/files/file9-mini.png" width="64" height="45" class="thumb"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/icons/finefiles/64/pdf.png" width="64" height="64"></span>
									...
									<li><a href="#">
										...
										<span><img src="assets/images/icons/finefiles/64/mp3.png" width="64" height="64"></span>
				...
				<div class="fieldset with-legend grey-bg clearfix">
					...
					<div class="mini-calendar float-right">
						...
						<div class="calendar-controls">
							...
							<a href="#" class="calendar-prev" title="Previous month"><img src="assets/images/cal-arrow-left.png" width="16" height="16"></a>

							<a href="#" class="calendar-next" title="Next month"><img src="assets/images/cal-arrow-right.png" width="16" height="16"></a>
			...
			<div class="block-border"><div class="block-content">
				...
				<div class="block-controls">
					...
					<ul class="controls-buttons">
						...
						<li><a href="#" title="Previous week"><img src="assets/images/icons/fugue/navigation-180.png" width="16" height="16"></a></li>
						...
						<li><a href="#" title="Next week"><img src="assets/images/icons/fugue/navigation.png" width="16" height="16"></a></li>
						...
						<ul>
							...
							<li class="from-10-15 to-11-45">
								...
								<ul class="mini-menu">
									...
									<li><a href="#" title="Edit"><img src="assets/images/icons/fugue/pencil.png" width="16" height="16"></a></li>

									<li><a href="#" title="Delete"><img src="assets/images/icons/fugue/cross-circle.png" width="16" height="16"></a></li>
							...
							<tr class="empty">
								...
								<td>
									...
									<ul class="mini-menu">
										...
										<li><a href="#" title="Add event"><img src="assets/images/icons/add.png" width="16" height="16"> Add event</a></li>
		...
		<section class="grid_4">
			...
			<div class="block-border"><div class="block-content">
				...
				<div class="task with-legend">
					...
					<div class="legend"><img src="assets/images/icons/fugue/status.png" width="16" height="16"> Standard task</div>
				...
				<div class="task with-legend">
					...
					<div class="legend"><img src="assets/images/icons/fugue/status-away.png" width="16" height="16"> Soon overdue task</div>
				...
				<div class="task with-legend">
					...
					<div class="legend"><img src="assets/images/icons/fugue/flag.png" width="16" height="16"> Overdue task</div>
					...
					<ul class="task-dialog">
						...
						<li>
							...
							<ul class="mini-menu">
								...
								<li><a href="#" title="Send mail"><img src="assets/images/icons/fugue/mail.png" width="16" height="16"></a></li>

								<li><a href="#" title="Delete comment"><img src="assets/images/icons/fugue/cross-circle.png" width="16" height="16"> Delete</a></li>
			...
			<div class="block-border"><div class="block-content">
				...
				<ul class="blocks-list">
					...
					<li>
						...
						<a href="#" class="float-left"><img src="assets/images/icons/fugue/status.png" width="16" height="16"> Task name</a>
			...
			<div class="block-border"><div class="block-content no-padding">
				...
				<div class="block-controls">
					...
					<ul class="controls-buttons">
						...
						<li><a href="#"><img src="assets/images/icons/fugue/control-skip-180.png" width="16" height="16"></a></li>

						<li><a href="#"><img src="assets/images/icons/fugue/control-double-180.png" width="16" height="16"></a></li>

						<li class="sep"></li>

						<li><a href="#"><img src="assets/images/icons/fugue/control-180.png" width="16" height="16"></a></li>

						<li><a href="#"><img src="assets/images/icons/fugue/control-pause.png" width="16" height="16"></a></li>

						<li><a href="#"><img src="assets/images/icons/fugue/control-stop-square.png" width="16" height="16"></a></li>

						<li><a href="#"><img src="assets/images/icons/fugue/control.png" width="16" height="16"></a></li>

						<li class="sep"></li>

						<li><a href="#"><img src="assets/images/icons/fugue/control-double.png" width="16" height="16"></a></li>

						<li><a href="#"><img src="assets/images/icons/fugue/control-skip.png" width="16" height="16"></a></li>

						<li class="sep"></li>

						<li><a href="#"><img src="assets/images/icons/fugue/control-eject.png" width="16" height="16"></a></li>

						<li><a href="#"><img src="assets/images/icons/fugue/control-power.png" width="16" height="16"></a></li>
					...
					<li>
						...
						<ul class="extended-options">
							...
							<li>
								...
								<img src="assets/images/icons/fugue/star.png" width="16" height="16"><img src="assets/images/icons/fugue/star.png" width="16" height="16"><img src="assets/images/icons/fugue/star.png" width="16" height="16"><img src="assets/images/icons/fugue/star-half.png" width="16" height="16"><img src="assets/images/icons/fugue/star-empty.png" width="16" height="16">
				...
				<div class="block-border">
					...
					<form class="block-content form" id="simple-list-form" method="post" action="">
						...
						<p class="input-type-text">
							...
							<img src="assets/images/icons/fugue/magnifier.png" width="16" height="16" class="float-right">
			...
			<div class="block-border"><div class="block-content">
				...
				<div class="block-controls">
					...
					<ul class="controls-buttons">
						...
						<li><a href="#" title="Previous page"><img src="assets/images/icons/fugue/navigation-180.png" width="16" height="16"></a></li>
						...
						<li><a href="#" title="Next page"><img src="assets/images/icons/fugue/navigation.png" width="16" height="16"></a></li>
			...
			<div class="block-border"><div class="block-content">
				...
				<div class="block-controls">
					...
					<ul class="controls-buttons">
						...
						<li><a href="#" title="Refesh"><img src="assets/images/icons/fugue/arrow-circle.png" width="16" height="16"></a></li>
			...
			<div class="block-border"><div class="block-content">
				...
				<div class="block-controls">
					...
					<ul class="controls-buttons">
						...
						<li><a href="#" title="Previous step"><img src="assets/images/icons/fugue/navigation-180.png" width="16" height="16"></a></li>

						<li><a href="#" title="Next step"><img src="assets/images/icons/fugue/navigation.png" width="16" height="16"></a></li>
				...
				<div class="gallery-preview no-margin">
					...
					<a href="#" class="prev"><img src="assets/images/icons/fugue/navigation-180.png" width="16" height="16"></a>

					<a href="#" class="next"><img src="assets/images/icons/fugue/navigation.png" width="16" height="16"></a>

					<a href="#"><img src="assets/images/demo/files/file1-medium.jpg" width="400" height="281"></a>
				...
				<ul class="gallery with-padding lite-grey-gradient no-margin">
					...
					<li><a href="#"><img src="assets/images/demo/files/file1-mini.png" width="64" height="45"></a></li>

					<li><a href="#"><img src="assets/images/demo/files/file2-mini.png" width="64" height="36"></a></li>

					<li><a href="#"><img src="assets/images/demo/files/file3-mini.png" width="64" height="43"></a></li>

					<li><a href="#"><img src="assets/images/demo/files/file4-mini.png" width="64" height="45"></a></li>

					<li><a href="#"><img src="assets/images/demo/files/file5-mini.png" width="64" height="50"></a></li>

					<li><a href="#"><img src="assets/images/demo/files/file6-mini.png" width="64" height="48"></a></li>
	...
	<footer>
		...
		<div class="float-right">
			...
			<a href="#top" class="button"><img src="assets/images/icons/fugue/navigation-090.png" width="16" height="16"> Page top</a>
	...
	<script src="assets/js/mini.php?files=libs/jquery-1.6.3.min,old-browsers,libs/jquery.hashchange,jquery.accessibleList,searchField,common,standard,jquery.tip,jquery.contextMenu,jquery.modal,list"></script>

	<!--[if lte IE 8]><script src="assets/js/standard.ie.js"></script><![endif]-->
	...
	<script src="assets/js/libs/jquery.datepick/jquery.datepick.min.js"></script>
